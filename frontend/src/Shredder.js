...
import shredderhd2 from "./images/shredder_hd.jpg"
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-6 col-md-3 mb-4">
              <Link to="/metalshredder">
                <div className="product-card">
                  <img src={shredderhd2} alt="Metal Shredder" className="product-img" />
            ...
            <div className="col-6 col-md-3 mb-4">
              <Link to="/plasticshredder">
                <div className="product-card">
                  <img src={shredderhd1} alt="Plastic Shredder" className="product-img" />
