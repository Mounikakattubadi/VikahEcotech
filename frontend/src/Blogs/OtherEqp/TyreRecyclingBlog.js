...
const faqsData = [
    {
        question: "Who are the leading tyre scrap recycling plant manufacturers in India?",
        answer:
...
const TyreRecyclingBlog = () => {
    ...
    const sections = [
        ...
        { id: "manufacturers", title: "Top Tyre Scrap Recycling Plant Manufacturers" },
    ...
    return (
        <div className={styles.pageWrapper}>
            ...
            <Helmet>
                <title>
                    Tyre Scrap Recycling Plant Manufacturers in India | Complete Industrial Solutions
                </title>

                <meta
                    name="description"
                    content="Explore the best tyre scrap recycling plant manufacturers in India. Learn how tyre recycling plants work, essential machinery, costs, benefits, and compliance details."
                />

                <meta
                    name="keywords"
                    content="tyre scrap recycling plant manufacturers in India, tyre recycling machinery India, tyre shredder manufacturers, tyre baling machines, rubber recycling plant India"
                />
                ...
                <meta
                    property="og:title"
                    content="Top Tyre Scrap Recycling Plant Manufacturers in India | Vikah Ecotech"
                />
                <meta
                    property="og:description"
                    content="Discover the leading tyre scrap recycling plant manufacturers in India and explore the entire recycling process, machinery, and benefits."
                />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "@type": "Article",
                        headline: "Tyre Scrap Recycling Plant Manufacturers in India",
                        description:
                ...
                <div className={styles.blogInner}>
                    ...
                    <div id="intro" className={styles.section}>
                        <div className={styles.imgLeft}>
                            ...
                            <span className={styles.caption}>Modern tyre scrap recycling plant</span>
                        </div>
                        ...
                        <p>
                            Leading manufacturers in India offer durable, customizable recycling
                            plants suitable for factories, municipal waste facilities, tyre
                            processing companies, and recycling units.
                        </p>
                    </div>
                    ...
                    <div id="demand" className={styles.section}>
                        <div className={styles.imgRight}>
                            ...
                            <span className={styles.caption}>India’s rising tyre scrap generation</span>
                        </div>

                        <h2>Growing Demand for Tyre Recycling Plants in India</h2>
                        <p>
                            Rapid urbanization, transportation growth, and industrial expansion
                            have resulted in massive tyre waste accumulation. Without proper
                            recycling, these tyres become fire hazards, mosquito breeding
                            grounds, and environmental threats.
                        </p>
                    ...
                    <div id="process" className={styles.section}>
                        ...
                        <ul className={styles.list}>
                            <li><strong>Tyre shredding:</strong> Breaking tyres into small pieces</li>
                            <li><strong>Steel wire extraction:</strong> Separating high-grade steel</li>
                            <li><strong>Rubber granulation:</strong> Producing crumb rubber</li>
                            <li><strong>Pyrolysis conversion:</strong> Converting rubber into oil & gas</li>
                            <li><strong>Baling:</strong> Compacting scrap for transport</li>
                        </ul>
                    ...
                    <div id="machinery" className={styles.section}>
                        ...
                        <p>
                            Each plant is customized based on tyre scrap volume, facility size,
                            and recycling goals.
                        </p>
                    </div>
                    ...
                    <div id="manufacturers" className={styles.section}>
                        <div className={styles.imgLeft}>
                            ...
                            <span className={styles.caption}>Manufacturing high-quality plants</span>
                        </div>
                        ...
                        <ul className={styles.list}>
                            <li><strong>Vikah Ecotech</strong> — Trusted for durable tyre balers & recycling machinery</li>
                        ...
                        <p>
                            These manufacturers supply turnkey plant solutions with installation,
                            automation setup, maintenance, and long-term service support.
                        </p>
                    </div>
                    ...
                    <div id="cost" className={styles.section}>
                        ...
                        <p>
                            Additional costs include land, labor, power supply, and environmental
                            clearances.
                        </p>
                    </div>
                    ...
                    <div id="why-us" className={styles.section}>
                        ...
                        <p>
                            ...
                            recycling machinery that ensure reliability, efficiency, and long-term
                            value. Our solutions are built for industrial durability and optimized
                    ...
                    <div id="conclusion" className={styles.section}>
                        ...
                        <p>
                            Tyre scrap recycling plants play a crucial role in India’s industrial
                            and environmental progress. With rising tyre waste, choosing the right
                            manufacturer ensures efficient processing, better revenue, and maximum
                            sustainability.
                        </p>
                    </div>
