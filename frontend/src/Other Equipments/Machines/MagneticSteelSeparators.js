...
const MagneticSteelSeparators = () => {
  ...
  return (
    <>
      {/* ===== SEO ===== */}
      <SEOHelmet
        title="Magnetic Steel Separators manufacturer in india"
        description="Vikah Ecotech Pvt Ltd is a leading Magnetic Steel Separators manufacturer in India offering high-performance overband magnetic separators for recycling, mining, waste management, and industrial applications."
        keywords="Magnetic Steel Separators manufacturer in India, Overband Magnetic Separator India, Magnetic Separator supplier India, Industrial magnetic separator, Conveyor magnetic separator"
        canonical="https://vikahecotech.com/magnetic-steel-separators"
        pageName="Magnetic Steel Separators"
        product={{
          name: "Overband Magnetic Steel Separators",
          description:
            "High-performance overband magnetic steel separators designed for efficient removal of ferrous metals from conveyor belts and waste streams.",
      ...
      <div className="tbf-page">
          ...
          <Container>
            <Row className="align-items-center">
              ...
              <Col md={6} className="text-center mt-4 mt-md-0">
                <img
                  src={oms}
                  alt="Overband Magnetic Steel Separator"
        ...
        <section className="tbf-contact-section text-white text-center py-5">
          <Container>
            ...
            <p className="mb-0">
              For more information about our Magnetic Steel Separators or to request a quote, please contact us at{" "}
              <a
