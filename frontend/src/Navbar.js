            ...
            <div ref={dropdownRef} className="nav-item dropdown mx-2">
              ...
              {showDropdown && !productMenu && (
                <ul className="dropdown-menu show" aria-labelledby="navbarDropdown">
                  <li><button className="dropdown-item" onClick={() => setProductMenu('baler')}>Balers</button></li>
                  <li><button className="dropdown-item" onClick={() => setProductMenu('shredder')}>Shredder</button></li>
                  <li><button className="dropdown-item" onClick={() => setProductMenu('tyreCutter')}>Tyre Cutting</button></li>
                  <li><button className="dropdown-item" onClick={() => setProductMenu('tyreFolding')}>Tyre Folding</button></li>
                </ul>
              )}
              ...
              {productMenu === 'shredder' && !subProductMenu && (
                <ul className="dropdown-menu show">
                  <li><button className="dropdown-item text-muted" onClick={handleBack}>← Back</button></li>
                  <li><Link to="/shredder" className="dropdown-item" onClick={handleNavigation}>Shredder</Link></li>
                  <li><button className="dropdown-item" onClick={() => setSubProductMenu('tyreShredder')}>Tyre Shredder</button></li>
                  <li><Link to="/metalshredder" className="dropdown-item" onClick={handleNavigation}>Metal Shredders</Link></li>
                  <li><Link to="/plasticshredder" className="dropdown-item" onClick={handleNavigation}>Plastic Shredder</Link></li>
                  <li><Link to="/papershredder" className="dropdown-item" onClick={handleNavigation}>Paper Shredder</Link></li>
