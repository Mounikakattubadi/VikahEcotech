    ...
    <>
      <header className={styles.productHeader}>
        <div className={styles.headerContent}>
          <div className={styles.breadcrumb}>
            Home / Products / <span>BLM-250 Metal Baler</span>
          </div>
          ...
          <p className={styles.productSubtitle}>
            Industrial-grade metal baler machine designed for large-scale
            recycling yards, handling steel punchings, cast scrap, automobile
            scrap, and both ferrous and non-ferrous metals with high compression
            force.
          </p>
      ...
      <div className="productpagetop">
          ...
          <div className="additional-images">
            <div>
              <img
                src={metalImg2}
                alt="BLM250 view 1"
                onClick={() => handleImageClick(metalImg2)}
              />
            </div>
            <div>
              <img
                src={metalImg3}
                alt="BLM250 view 2"
                onClick={() => handleImageClick(metalImg3)}
              />
            </div>
            <div>
              <img
                src={metalImg1}
                alt="BLM250 view 3"
                onClick={() => handleImageClick(metalImg1)}
              />
            </div>
          </div>
        </div>
        ...
        <div className="productdetails">
          <h1>BLM-250</h1>
          <p>
            The <strong>BLM-250</strong> is a high-force industrial metal baler
            designed for large-scale recycling yards. Suitable for ferrous &
            non-ferrous metals including steel punchings, cast scrap, and
            automobile pressing.
          </p>
        </div>
      </div>
      ...
      <div className="features-container">
        ...
        <div className="features-content">
          <img
            ...
            alt="BLM250 specifications"
          />
          <div className="sht200specification">
            <p>
              ➤ 250-ton powerful compression
              <br />
              ➤ Robust welded frame
              <br />
              ➤ Auto-eject system
              <br />
              ➤ High-density bale output
              <br />
              ➤ PLC automation
              <br />
            </p>
      ...
      <div className="featurestable">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td>Bale Size</td>
              <td>1400 × 900 × (700–900)</td>
            </tr>
            <tr>
              <td>Chamber Size</td>
              <td>1800 × 1000 × 700 mm</td>
            </tr>
            <tr>
              <td>Capacity</td>
              <td>5–7 Bales/hr</td>
