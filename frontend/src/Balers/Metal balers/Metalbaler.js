...
<div className="container-fluid px-4 px-md-5 my-5">
  ...
  <div className="container-fluid py-5">
    <div className="row justify-content-center">
      <div className="col-12 col-lg-10 text-center">
        ...
        >
          Vikah Ecotech manufactures hydraulic metal scrap balers for efficient recycling of ferrous and non-ferrous metals including aluminum, copper, brass, mild steel, and stainless steel.
          Our machines are engineered for high compaction, durability, and consistent performance in scrap yards, foundries, and industrial recycling plants.
        </p>
        ...
        >
          Built with heavy-duty steel frames and high-pressure hydraulic systems, our metal balers reduce storage space, improve handling efficiency, and provide uniform bale formation for metal scrap.
        </p>
        ...
        >
          Available in 150 Ton, 200 Ton, and 250 Ton models (BLM150, BLM200, BLM250),
          Vikah Ecotech metal balers guarantee reliable operation, low maintenance, and long-term industrial performance.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="container mb-5">
    ...
    <p className="text-center mb-4">
      Our hydraulic metal scrap balers are widely used in recycling plants, foundries,
      metal scrap yards, industrial warehouses, and commercial metal collection centers for
      high-density metal compaction.
    </p>
  ...
  <div className="container mb-5">
    ...
    <p>
      Vikah Ecotech is a trusted metal baler manufacturer in India due to our robust design,
      reliable hydraulic systems, and long-lasting performance. Our balers are designed
      for continuous industrial operations and maximum compaction efficiency.
    </p>

    <ul>
      <li>Heavy-duty hydraulic cylinders for powerful metal compression</li>
  ...
  <div className="container mb-5">
    ...
    <p>
      Our metal scrap balers are built with high-pressure hydraulic systems, reinforced steel
      frames, and safety features to ensure uniform pressure distribution and high-density bales.
      Suitable for aluminum, copper, brass, steel, and other ferrous/non-ferrous metal scrap.
    </p>
  </div>
