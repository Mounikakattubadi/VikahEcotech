      ...
      <div className="productpagetop">
        ...
        <div className="productdetails">
          ...
          <p>
            ...
            recycling operations, offering strong performance with a compact
            footprint. Its 150-ton compaction force and durable MS steel chamber
            produce uniform, dense bales that lower storage needs and reduce
            transport costs. A smooth hydraulic system with precision cylinders
            ensures consistent operation and stable bale quality. The BLT-150
            includes user-friendly controls, safety guards, and emergency-stop
            systems, making it safe and simple for operators to use. With low
            maintenance requirements and accessible service points, it delivers
