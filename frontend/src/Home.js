...
import './Home.css';
import gif from './images/top2.gif';
...
function Home() {
  ...
  return (
    <>
      <div className="home-container" onClick={scrollToProducts} style={{ cursor: "pointer" }}>
        <img src={gif} alt="Top Animation" />
      </div>

      <div className="container my-5">
  <div className="text-center mx-auto" style={{ maxWidth: "800px" }}>
    <h2 className="green-heading mb-3">Your Partner in Sustainable Recycling Solutions</h2>
    <p className="mb-4">
      At Vikah Ecotech, we are dedicated to pioneering innovative
      solutions in the field of recycling machinery manufacturing. With
      a commitment to sustainability and environmental stewardship, we
  ...
  <div className="container">
    ...
    <div className="row align-items-center mb-5">
      <div className="col-md-6">
        <img src={Baler} alt="Balers" className="img-fluid rounded shadow product-feature-img" />
      </div>
      <div className="col-md-6">
        <h3 className="green-heading">Balers</h3>
        <p>Compact your recyclable materials with our efficient balers — engineered for durability and easy operation.</p>
        <Link to="/Baler" className="btn btn-outline-success">View Balers</Link>
      </div>
    </div>
    ...
    <div className="row align-items-center mb-5 flex-md-row-reverse">
      <div className="col-md-6">
        <img src={shredderhdimg} alt="Shredders" className="img-fluid rounded shadow product-feature-img" />
      </div>
      <div className="col-md-6">
        <h3 className="green-heading">Shredders</h3>
        <p>Heavy-duty shredding systems designed to break down tires, plastics, and more into manageable pieces.</p>
        <Link to="/shredder" className="btn btn-outline-success">View Shredders</Link>
      </div>
    </div>

    {/* Product: Cutting Equipment */}
    <div className="row align-items-center mb-5">
      <div className="col-md-6">
        <img src={Tyrecuttingimg} alt="Cutting Equipment" className="img-fluid rounded shadow product-feature-img" />
      </div>
      <div className="col-md-6">
        <h3 className="green-heading">Cutting Equipment</h3>
        <p>Our cutting solutions ensure precision and safety in tire processing operations.</p>
        <Link to="/tyrecutting" className="btn btn-outline-success">View Cutting Equipment</Link>
      </div>
    </div>

    {/* Product: Folding Equipment */}
    <div className="row align-items-center mb-5 flex-md-row-reverse">
      <div className="col-md-6">
        <img src={tyrefolding} alt="Folding Equipment" className="img-fluid rounded shadow product-feature-img" />
      </div>
      <div className="col-md-6">
        <h3 className="green-heading">Folding Equipment</h3>
        <p>Innovative folding machines for space-saving solutions in recycling and logistics.</p>
        <Link to="/tyrefolding" className="btn btn-outline-success">View Folding Equipment</Link>
      </div>
    </div>
  </div>
</div>
...
{/* Trade Fair Section */}
<div className="container my-5">
  <h2 className="green-heading text-center mb-4">Trade Fairs & Exhibitions</h2>
  <div className="position-relative">
    {/* Scroll Buttons */}
    <button className="scroll-btn left" onClick={() => scrollCards('left')}>&#8249;</button>
    <button className="scroll-btn right" onClick={() => scrollCards('right')}>&#8250;</button>

    {/* Scrollable Cards */}
    <div className="trade-scroll-wrapper" id="tradeCardScroll">
    <div className="trade-card">
        <img src={envirotechimg} alt="EnviroTech Asia" className="trade-img" />
        <div className="trade-content p-3">
          <h5>EnviroTech Asia 2024 is a premier International Exhibition and Summit focused on sustainable environmental practices.</h5>
          ...
          <Link to="/Tradefairs" className="btn btn-success">Know More</Link>
        </div>
      </div>
      {/* Card 1 */}
      <div className="trade-card">
        ...
        <div className="trade-content p-3">
          <h5>India's Leading Trade Fair for Water, Sewage, Solid Waste & Recycling</h5>
          <p>IFAT India has been bringing together professionals and experts from various sectors of the water, sewage, waste,
             and recycling industry, providing the entire industry with a platform for knowledge exchange, networking,
             and the opportunity to forge partnerships between industry players, policy makers, and environmental experts.</p>
          <p><strong>Date:</strong> 16–18 Oct 2024</p>
          <p><strong>Location:</strong> Mumbai Exhibition Centre</p>
          <p><strong>Booth No:</strong> D016, Hall:3</p>
          <Link to="/ifat" className="btn btn-success">Know More</Link>
        </div>
      </div>

      {/* Card 2 */}
      <div className="trade-card">
        <img src={ecosustainimg} alt="Eco Sustain Expo" className="trade-img" />
        <div className="trade-content p-3">
          ...
          <p><strong>Date:</strong> 16–18 Aug 2024</p>
          <p><strong>Location:</strong> HITEX Exhibition Center, Hyderabad</p>
          <p><strong>Booth No:</strong> 4N01</p>
          <Link to="/completedTradefair1" className="btn btn-success">Know More</Link>
        </div>
      </div>

      {/* Card 3 - EnviroTech Asia */}
...
<div className="testimonial-section" style={{ backgroundImage: `url(${bgImage})` }}>
  <div className="testimonial-card">
    <h4 className="green-heading mb-4">What Our Clients Say</h4>
    <button className="testimonial-btn left" onClick={prev}>&#8249;</button>
    ...
    <div className="testimonial-content">
      ...
      <h5 className="testimonial-company">{testimonials[current].company}</h5>
      <p className="testimonial-text">"{testimonials[current].feedback}"</p>
      <p className="testimonial-author">– {testimonials[current].author}</p>
    </div>

    <button className="testimonial-btn right" onClick={next}>&#8250;</button>
  </div>
</div>
