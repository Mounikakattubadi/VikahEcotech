    ...
    <>
      <div className='productpagetop'>
        <div className='imagetop'>
          ...
          <div className="additional-images">
            <div>
              <img src={img2} alt="Angle 1" onClick={() => handleImageClick(img2)} />
            </div>
            <div>
              <img src={balerImage} alt="Angle 2" onClick={() => handleImageClick(balerImage)} />
            </div>
            <div>
              <img src={img1} alt="Angle 3" onClick={() => handleImageClick(img1)} />
            </div>
          </div>
        </div>
      ...
      <div className='features-container'>
        ...
        <div className='features-content'>
          <img src={mainSpecImage} alt="Specifications" className="specifications-image" />
