      ...
      <div className="container my-5">
        <div className="row gy-4 p-3">
          ...
          {/* Upcoming: Recycling Expo Middle East 2025 */}
              ...
              <p><strong>Date:</strong> 11-11-2025 to 12-11-2025</p>
            ...
            <div className="tradefairs-card h-100 d-flex flex-column position-relative">
              ...
              <div className="tradefairs-content flex-grow-1 d-flex flex-column justify-content-between p-3">
                <div>
                  ...
                  <p>
                    Eco Sustain Expo & Conference, an exceptional event meticulously crafted by HITEX, Hyderabad that brings together a diverse community of
                    ...
                    Be part of this impactful movement with HITEX and let’s create a positive ripple effect for our planet.
                  </p>
            ...
            <div className="tradefairs-card h-100 d-flex flex-column">
              ...
              <div className="tradefairs-content flex-grow-1 d-flex flex-column justify-content-between p-3">
                <div>
                  ...
                  <p>
                    Eco Sustain Expo & Conference, an exceptional event meticulously crafted by HITEX, Hyderabad that
                    brings together a diverse community of professionals, visionaries, policymakers, researchers, and
                    solution providers, all bound by a resolute dedication to shaping a sustainable future.
                  </p>
            ...
            <div className="tradefairs-card h-100 d-flex flex-column">
              ...
              <div className="tradefairs-content flex-grow-1 d-flex flex-column justify-content-between p-3">
                <div>
                  <h5 className="mb-2">Eco Sustain Expo & Conference</h5>
                  <p>
                    Eco Sustain Expo & Conference, an exceptional event meticulously crafted by HITEX, Hyderabad that brings together
                    ...
                    and ignite a cleaner, greener world. Be part of this impactful movement with HITEX and let’s create a positive ripple effect for our planet.
                  </p>
